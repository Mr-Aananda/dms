<template>
    ...
    <!-- Cash Select -->
    <div v-if="payment_method == 'cash'" class="col-10 mt-3">
    ...
    <!-- Cash Balance show -->
    <div v-if="cash_balance != null" class="col-10 mt-2">
    ...
    <div v-if="payment_method == 'bank'" class="row mt-3">
        ...
        <!-- Bank Balance show -->
        <div v-if="bank_balance != null" class="col-10 mt-2">
...
const oldDueManageData = () => {
    if (props.oldDueManage.cash_id) {
        payment_method.value = 'cash'
        cash_id.value = props.oldDueManage.cash_id
    }else{
        payment_method.value = 'bank'
        bank_id.value = props.oldDueManage.bank_account.bank_id
        getBankAccount()
        bank_account_id.value = props.oldDueManage.bank_account_id
        check_number.value = props.oldDueManage.check_number
    }
}
...
onMounted( async () => {
    ...
    // console.log(props.oldDueManage);
