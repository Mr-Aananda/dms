@section('title', 'Create Income Record')
<x-app-layout>
    <!-- Start main-bar -->
    <!-- Start header widget -->
        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-body">
                    <form action="{{ route('income-record.store') }}" method="POST" id="vueRoot">
                        @csrf
                        ...
                        <div class="row g-3 mb-2">
                            <div class="col-md-10">
                                <x-form.label name="Income Sector" for="income-sector" required/>
                                <x-form.select
                        ...
                        <div class="row g-3 mb-2">
                            ...
                            <div class="col-md-5">
                                <x-form.label name="Income By" for="income-by"/>
                                <x-form.input type="text" id="income-by" name="income_by" placeholder="Enter collector name "/>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-10 text-end">
                                <x-form.reset/>
                                <x-form.save name="New Income Record"/>
                            </div>
                        </div>
                    </form>
                </div>
