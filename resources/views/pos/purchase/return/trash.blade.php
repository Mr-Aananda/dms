@section('title', 'Purchase Return Trash')
    ...
    <div class="widget mb-3 border-top print-none">
        ...
        <!-- End left menu -->
            ...
            <div class="ms-auto">
                ...
                <a class="btn icon lg rounded" title="Reload" href="{{ route('purchase-return.trash') }}">
    ...
    <div id="print-widget">
        ...
        <div class="widget">
            <div class="widget-head mb-3">
                <h5>All purchase return trashes</h5>
                            ...
                            <tr>
                               <th>{{ $returns?->firstItem() + $index }}</th>
                                ...
                                <td class="text-end print-none">
                                    <a href="{{ route('purchase-return.restore', $return->id) }}" class="btn btn-primary sm">
                                    ...
                                    <form action="{{ route('purchase-return.permanentDelete', $return->id) }}"
