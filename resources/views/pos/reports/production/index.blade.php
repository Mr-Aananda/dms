...
<x-app-layout>
    ...
    <div class="widget mb-3">
        <div class="widget-body d-flex">
            <!-- Start menu -->
        @include('pos.reports.production.menu')
        <!-- End menu -->
            <!-- Start right buttons -->
            <div class="ms-auto">
        ...
        <div class="widget-body collapse {{ request()->search == '1' ? 'show' : '' }}" id="tableSearch">
            <form action="{{ route('report.production-report') }}" method="get">
                        ...
                        @forelse($productions as $index => $production)
                            ...
                            <tr>
                                ...
                                <td class="text-end print-none">
                                    <a href="{{ route('production.show', $production->id) }}" class="btn btn-primary sm" target="__blank">
