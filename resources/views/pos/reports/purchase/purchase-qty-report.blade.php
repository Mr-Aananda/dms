@section('title', 'Purchase Quantity Report')
...
<x-app-layout>
    ...
    <div class="widget mb-3">
        ...
        <div class="widget-body collapse {{ request()->search == '1' ? 'show' : '' }}" id="tableSearch">
            <form action="{{ route('report.purchase-qty-report') }}" method="get">
    ...
    <div id="print-widget">
        ...
        <div class="widget">
            <div class="widget-head mb-3">
                <h5>Report: Purchase Quantity Report</h5>
            ...
            <div class="widget-body">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @forelse($purchase_details as $detail)
                        @if (request()->search)
                         <tr>
        ...
        <!-- Start pagination -->
        <x-pagination :items="$purchase_details" />
    <!-- End pagination -->
    <!-- End main-bar-->
    @push('script')
        <script>
