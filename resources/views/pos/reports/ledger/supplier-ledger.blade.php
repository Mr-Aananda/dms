                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="text-end">
                                ...
                                @endphp
                                {{ number_format(abs($opening_balance - $total_adjustment), 2) }}
                            ...
                            <tr>
                                ...
                                <td class="text-wrap">
                                    @if ($ledger->type === 'purchase')
                                        <span class="fw-bold"> Product Purchase</span>
                                        <br>
                                ...
                                <td class="text-end">
                                    ...
                                    @elseif ($ledger->type === 'purchase_return')
                                        ...
                                        {{-- {{ number_format($ledger->return_total_paid , 2) }} --}}
                                    @elseif ($ledger->type === 'due_manage')
                                ...
                                <td class="text-end print-none">
                                    @if ($ledger->type === 'purchase')
                                        <a href="{{ route('purchase.show', $ledger->id) }}"
                                            class="btn btn-primary sm" title="View Voucher" target="_blank">
                                            <i class="bi bi-eye"></i>
                                        </a>

                                    @elseif ($ledger->type === 'purchase_return')
                                        <a href="{{ route('purchase-return.show', $ledger->id) }}"
                                            class="btn btn-primary sm" title="View Return Voucher" target="_blank">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    @else
