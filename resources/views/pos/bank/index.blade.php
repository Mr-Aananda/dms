            ...
            <form action="{{ route('bank.index') }}" method="get">
                <div class="row py-3 g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" list="bankList" name="name" id="bank"
                               placeholder="Type a bank name" value="{{ request()->name }}">
                    </div>
                    <div class="col-md-2">
    ...
    <div id="print-widget">
        ...
        <div class="widget">
            <div class="widget-head mb-3">
                <h5>All Banks</h5>
                <p><small>{{ count($banks) }} results found </small></p>
            </div>
                                ...
                                @can('bank.destroy')
                                    <form action="{{ route('bank.destroy', $bank->id) }}" method="POST"
                                        ...
                                        <button type="submit" title="Delete"
                                                {{ $bank->bank_accounts_count > 0 ? 'disabled' : '' }} class="btn sm btn-danger">
