@section('title', 'Supplier Due Manages')
...
<x-app-layout>
    ...
    <div class="widget mb-3">
        ...
        <div class="widget-body collapse {{ request()->search == '1' ? 'show' : '' }}" id="tableSearch">
             <form action="{{ route('supplier-due.index') }}" method="GET">
                    ...
                    @forelse($dueManages as $due)
                        <tr>
                            ...
                            <td class="text-end print-none">
                                ...
                                @can('supplier-due.edit')
                                    <a href="{{ route('supplier-due.edit', $due->id) }}"
                                        class="btn sm btn-primary" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                @endcan

                                @can('supplier-due.destroy')
                                    <form action="{{ route('supplier-due.destroy', $due->id) }}" method="POST"
                                            class="d-inline"
