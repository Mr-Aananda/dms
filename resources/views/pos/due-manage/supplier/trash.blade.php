@section('title', 'Supplier Due Trash')
    ...
    <div class="widget mb-3 border-top print-none">
        ...
        <!-- End left menu -->
            ...
            <div class="ms-auto">
                ...
                <a class="btn icon lg rounded" title="Reload" href="{{ route('supplier-due.trash') }}">
                        ...
                        @foreach($dueManages as $index => $due)
                            <tr>
                                ...
                                <td class="text-end print-none">
                                    <a href="{{ route('supplier-due.restore', $due->id) }}" class="btn btn-primary sm">
                                    ...
                                    <form action="{{ route('supplier-due.permanentDelete', $due->id) }}"
