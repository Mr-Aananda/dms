<div class="modal fade" id="profitAddCreateModal" tabindex="-1" aria-labelledby="profitAddModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Profit to invest amount</h5>
      ...
      <div class="modal-body">
        <form action="{{ route('invest-withdraw.store') }}" method="POST">
            ...
            <div>
                <input type="hidden" name="type" value="profit_addition">
