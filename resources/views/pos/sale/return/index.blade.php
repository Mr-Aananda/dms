                    ...
                    <tbody>
                        ...
                        @forelse($returns as $index => $return)
                                @php
                                    ...
                                    $totalDueChange += ($return->return_grand_total - $return->return_total_paid);
                                @endphp
                            ...
                            <tr>
                                ...
                                <td>{{ $return?->party_name }} ({{ $return?->party?->phone }})</td>
                                ...
                                <td class="text-end">
                                    {{ number_format(abs($return?->return_grand_total - $return?->return_total_paid), 2) }}
                                </td>
                                <td class="text-end print-none">
                                    <a href="{{ route('sale-return.show', $return->id) }}" class="btn btn-primary sm">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>
                                    <a href="{{ route('sale-return.edit', $return->id) }}" class="btn btn-warning sm">
                                    ...
                                    <form action="{{ route('sale-return.destroy', $return->id) }}"
