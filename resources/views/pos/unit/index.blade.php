            ...
            <form action="{{ route('unit.index') }}" method="get">
                <div class="row py-3 g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" list="unitList" name="name" id="unit"
                               placeholder="Type a unit name" value="{{ request()->name }}">
                    </div>
                    <div class="col-md-2">
    ...
    <div id="print-widget">
        ...
        <div class="widget">
            <div class="widget-head mb-3">
                <h5>All Units</h5>
                <p><small>{{ count($units) }} results found </small></p>
            </div>
                                ...
                                @can('unit.destroy')
                                    <form action="{{ route('unit.destroy', $unit->id) }}" method="POST"
                                        ...
                                        <button type="submit" title="Delete"
                                                {{ $unit->products_count > 0 ? 'disabled' : '' }} class="btn sm btn-danger">
