        ...
        <div class="col-lg-3">
            <div class="widget">
                <div class="widget-head border-bottom pb-3 text-center mb-2">
                    ...
                    {{-- <button type="button" class="btn icon lg rounded text-danger" title="Delete This Product">
                    ...
                    <form action="{{ route('user.destroy', $user->id) }}" method="POST" class="d-inline"
                        ...
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn icon lg rounded text-danger" title="Delete">
                            <i class="bi bi-trash"></i>
                        </button>
                    </form>
                </div>
