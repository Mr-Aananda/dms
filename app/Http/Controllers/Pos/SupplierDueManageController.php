...
class SupplierDueManageController extends Controller
{
    ...
    public function index()
    {
        ...
        $dueManages = $dueManages_query->with('party')->where('type', 'supplier')->latest()->paginate(30)->withQueryString();
        $parties = Party::supplier()->get();

        return view('pos.due-manage.supplier.index', compact('dueManages', 'parties'));
    }
    ...
    {
        $type = "supplier";
        return view('pos.due-manage.supplier.create',compact('type'));
    }
    ...
    public function edit(string $id)
    {
        ...
        // view
        return view('pos.due-manage.supplier.edit', compact('dueManage', 'type'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('supplier-due.index')->withSuccess('Due manage delete successfully!');
    }
    ...
    {
        $dueManages = DueManage::latest()->where('type', 'supplier')->onlyTrashed()
            ->paginate(30)
            ->withQueryString();

        return view('pos.due-manage.supplier.trash', compact('dueManages'));
    }
